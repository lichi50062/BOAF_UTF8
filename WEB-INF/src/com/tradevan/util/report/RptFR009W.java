...
public class RptFR009W {
  	public static String createRpt(String s_year,String s_month,String unit,String title_bank_name,String bank_type,List bank_list)
	{
		...
		boolean isData = false;  //判斷是否有在選取的清單中
		...
		try{				
			...
			HSSFCellStyle cs2 = wb.createCellStyle();
        	 ...
        	 cell.setCellValue( title_bank_name +"警示帳戶調查統計明細表");	
       ...
       cell = row.getCell( (short) 0);		
			 ...
			 cell.setCellValue(s_year+"年"+s_month+"季");									   
	...
	//取得bank_list的bank_no
	String bank_id = "";	
	System.out.println("bank_list= "+bank_list);
     if(bank_list!=null){
...
List paramList =new ArrayList() ;
 String sqlCmd =                                                                                          
"  select   *  from (  "+
"  select nvl(cd01.hsien_id,' ')       as  hsien_id ,nvl(cd01.hsien_name,'OTHER')  as  hsien_name,"+
...
//==========================================================================================================		
		...
		List temp ;	  
     	...
     	if(isSelected){
 		   ...
 		   for(int cellcount=0;cellcount<8;cellcount++){
        	             ...
        	             //{ cell.setCellValue(hsien_name);	bank_name_temp = bank_name;}
	...
	if(!isData){
       ...
       cell = row.getCell( (short) 0);		
			 cell.setEncoding(HSSFCell.ENCODING_UTF_16);			
			 cell.setCellValue(s_year+"年"+s_month+"季無資料");									   
         ft2.setFontHeightInPoints((short)12);
		     ft2.setFontName("標楷體");
		     cs2.setFont(ft2);
		     cs2.setAlignment(HSSFCellStyle.ALIGN_CENTER);
