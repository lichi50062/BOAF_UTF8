/*
 * 108.04.16 create 全體農漁會信用部各身分別放款金額一覽表  by 2295
*/
...
public class RptFR082W {
  	...
  	public static String createRpt(String s_year,String s_month,String unit)
	{
        ...
        String field_990410 = "";  
        String field_990410_rate = "";
        String field_990610 = "";
        String field_990610_rate = "";
        String field_credit = "";
        DecimalFormat formatter = new DecimalFormat("#.##");
        DataObject bean = null;
        
        
		filename="全體農漁會信用部各身分別放款金額一覽表.xls";
		...
		try{				
            ...
            if (dbData !=null && dbData.size() !=0) {
                for(int i=0;i<dbData.size();i++){
                    ...
                    field_990410 = bean.getValue("field_990410") == null?"":Utility.setCommaFormat(String.valueOf(bean.getValue("field_990410")));//贊助會員-金額
                    field_990410_rate = bean.getValue("field_990410_rate") == null?"":Utility.setCommaFormat(String.valueOf(bean.getValue("field_990410_rate")));//贊助會員-比例
                    field_990610 = bean.getValue("field_990610") == null?"":Utility.setCommaFormat(String.valueOf(bean.getValue("field_990610")));//非會員-金額
                    field_990610_rate = bean.getValue("field_990610_rate") == null?"":Utility.setCommaFormat(String.valueOf(bean.getValue("field_990610_rate")));//非會員-比例
                    field_credit = bean.getValue("field_credit") == null?"":Utility.setCommaFormat(String.valueOf(bean.getValue("field_credit")));//存款總額
                    ...
                    cell.setCellValue(field_990410);
                    //贊助會員-比例
                    cell=row.getCell((short)6);                
                    cell.setCellValue(field_990410_rate);
                    //非會員-金額
                    cell=row.getCell((short)7);
                    cell.setCellValue(field_990610);
                    //非會員-比例
                    cell=row.getCell((short)8);            
                    cell.setCellValue(field_990610_rate);
                    //存款總額
                    cell=row.getCell((short)9);          
                    cell.setCellValue(field_credit);    
  	...
  	public static List getData1(String s_year,String s_month,String unit){
        ...
        sql.append(" field_CREDIT - field_990410 - field_990610  as  field_mem,");//--會員-金額      
        sql.append(" decode(field_CREDIT,0,0,round((field_CREDIT - field_990410 - field_990610) / field_CREDIT *100 ,2)) as field_mem_rate,");//--會員-比例 
        sql.append(" field_990410, ");//--贊助會員-金額                     
        sql.append(" decode(field_CREDIT,0,0,round(field_990410 / field_CREDIT *100 ,2)) as field_990410_rate,");//--贊助會員-比例 
        sql.append(" field_990610, ");//--非會員-金額                 
        sql.append(" decode(field_CREDIT,0,0,round(field_990610 / field_CREDIT *100 ,2)) as field_990610_rate,");//--非會員-比例
        sql.append(" field_CREDIT ");//--總額                      
        sql.append(" from "); 
        ...
        sql.append("         round(sum(decode(a01.acc_code,'990410',amt,0)) /?,0) as  field_990410,");//  --贊助會員-存款總額                 
        sql.append("         round(sum(decode(a01.acc_code,'990610',amt,0)) /?,0) as  field_990610,");//  --非會員-存款總額                 
        sql.append("         round(sum(decode(a01.acc_code,'120000',amt,'120800',amt,'150300',amt,0)) /?,0) as  field_CREDIT");// --存款總額
        paramList.add(unit);  
        paramList.add(unit);
        paramList.add(unit);
        ...
        List dbData = DBManager.QueryDB_SQLParam(sql.toString(),paramList,"field_mem,field_mem_rate,field_990410,field_990410_rate,field_990610,field_990610_rate,field_credit");
