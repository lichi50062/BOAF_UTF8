...
public class JakartaFtpSWrapper extends FTPSClient {
	 ...
	 * @throws IOException
	 */
	public boolean changeWorkingDir (String remote_path) throws IOException{
		  return (changeWorkingDirectory(remote_path)); 
	}
