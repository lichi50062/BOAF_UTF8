// Decompiled by DJ v2.9.9.61 Copyright 2000 Atanas Neshkov  Date: 2005/12/23 ¤U¤È 03:03:12
...
public class SmartUpload
{
        ...
        throws ServletException, IOException, SmartUploadException
    {
        ...
        System.out.println(" m_contentDisposition="+ m_contentDisposition);
        
        
        
        if(s2 == null){
            m_response.setHeader("Content-Disposition", m_contentDisposition + " filename=" + getFileName(s));
            System.out.println("Content-Disposition="+m_contentDisposition + " filename=" + getFileName(s));
        }else if(s2.length() == 0){
            m_response.setHeader("Content-Disposition", m_contentDisposition);
            System.out.println("Content-Disposition="+ m_contentDisposition);
        }else{
            m_response.setHeader("Content-Disposition", m_contentDisposition + " filename=" + s2);
            System.out.println("Content-Disposition="+m_contentDisposition + " filename=" + s2);
        }    
        while((long)k < l) 
        {
