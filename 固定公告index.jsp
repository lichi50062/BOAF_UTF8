...
<%!
    ...
    private List Get_WLX_Notify(){
        ...
        //List dbData = DBManager.QueryDB(sqlCmd,"seq_no");            
        return dbData;
    }
%>
                ...
                <td><table width="330" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#006666">
                    <tr>
		              ...
		              <tr colspan="0" bordercolor="#63B1AE" bgcolor="#408C87"><img src="images/hotnews.gif" width="70" height="18"></tr>	
		                 ...
		                 document.write("&nbsp;<a href=\"javascript:doLink('/pages/DomloadNotify.jsp?seq_no=17');\"><img src=images/download.gif border=0></a>&nbsp;<font size='2' "); 		 									   
		                 document.write("color=white>104/01/01 12:00&nbsp;本系統帳號鎖定請下載申請單並請洽本局工程師(tel:02-33935821)</font><br>");					   		
