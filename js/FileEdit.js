function doSubmit(DLId, DLIdName) {
	var form = document.frmFileEdit;
	form.DLId.value = DLId;
	form.DLIdName.value = DLIdName;
	form.act.value="Status";		
	form.action="/pages/FileEdit.jsp?act="+form.act.value+"&FileName="+form.UpFileName.value+"&test=nothing";	
	form.submit();
}
