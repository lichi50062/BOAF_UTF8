<%
// 95.06.16 add 增加由request 取得table width by 2295
...
<%
	...
	String width="";
	//95.06.16 fix 增加由request 取得table width by 2295
	if(request.getAttribute("table_width") != null){
	   width = (String)request.getAttribute("table_width");
	}else{
	   width=(request.getParameter("width") == null)?"600":(String)request.getParameter("width");
	}   
%>
 <td><table width=<%=width%> border=1 align='center' cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
     <tr bgcolor="#9AD3D0" class="sbody"> 
     <td width=100 bgcolor=#9AD3D0><font face=細明體 color=#000000>機構名稱</font></td>
     <td width=270><font face=細明體 color=#000000><%=bank_name%></font></td>
     <td width=100><font face=細明體 color=#000000>作業人員</font></td>
