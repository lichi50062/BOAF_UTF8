...
<%@ page import="com.tradevan.util.report.RtpFX008W_Print2" %>
...
<%
	...
	String S_MONTH = ( request.getParameter("S_MONTH")==null ) ? "" : (String)request.getParameter("S_MONTH");
	 ...
	 String filename="農金局承受擔保品申請延長處分期限審核表.xls";
	 String unit ="1";   
	 String BankList=""; 
   String bank_no=""; 
   String tbank_no="";   
   ...
   String muser_id = ( session.getAttribute("muser_id")==null ) ? "" : (String)session.getAttribute("muser_id");	          
	 	...
	 	if(bank_type.equals("2")||muser_id.equals("A111111111")){
...
<%
	try{
	   String actMsg = RtpFX008W_Print2.createRpt(S_YEAR,S_MONTH,unit,bank_name,bank_type,bank_no);	
	    System.out.println("createRpt="+actMsg);
	    FileInputStream fin = null;
		
			System.out.println("filename="+Utility.getProperties("reportDir")+System.getProperty("file.separator")+"農金局承受擔保品申請延長處分期限審核表.xls");
	   	fin = new FileInputStream(Utility.getProperties("reportDir")+System.getProperty("file.separator")+"農金局承受擔保品申請延長處分期限審核表.xls");
