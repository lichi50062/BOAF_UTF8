...
<%
	...
	System.out.println("DS016W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("DS016W_BankList.hsien_id="+hsien_id);
	...
	String E_MONTH = (session.getAttribute("E_MONTH")==null)?MONTH:(String)session.getAttribute("E_MONTH");            
   	...
   	//String acc_div = (session.getAttribute("acc_div")==null)?"01":(String)session.getAttribute("acc_div");    
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("DS016W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
