...
<%
    ...
    if (permission == null) {
        System.out.println("TM003W_List.permission == null");
    }else {
        System.out.println("TM003W_List.permission.size ="+permission.size());
    }
                ...
                <td width="770">
                  <table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="365" align="center"><b><center><font color="#000000" size="4">適用協助措施之經辦機構預估需求填報作業</font></center></b> </td>
                      ...
                      <table class="sbody" width="770" border=1 cellpadding="0" cellspacing="1" bordercolor="#3A9D99" height="20" >
                          ...
                          %>
                           <tr class="sbody" bgcolor="<%out.print((i%2==0)?"#FFFFE6":"#F2F2F2");%>">
	                           ...
	                           <a href='TM003W.jsp?act=Edit&acc_Tr_Type=<%=String.valueOf(((DataObject)dbData.get(i)).getValue("acc_tr_type")) %>'>
