...
<%
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp//95.11.03 fix 使用Utility.CheckPermission檢核權限 by 2295
        ...
        if(act.equals("RptColumn")){//報表欄位              
			//List FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"A99_"+bank_type+"_master_"+acc_div+".TXT");						
			//System.out.println(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"A99_"+bank_type+"_master_"+acc_div+".TXT");
			List FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"A99_"+bank_type+"_master.TXT");						
            ...
            if(bank_type.equals("ALL") && session.getAttribute("BankList") != null && ((String)session.getAttribute("BankList")).indexOf("ALL") != -1){
              FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"A99_ALL_master.TXT");						
            }
			System.out.println(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"A99_"+bank_type+"_master.TXT");
...
<%!
    private final static String report_no = "DS016W";
