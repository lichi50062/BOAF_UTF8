...
<%
	...
	System.out.println("DS015W_RptOrder.szExcelAction="+szExcelAction);
	...
	<table width="750" border="0" align="center" cellpadding="1" cellspacing="1">        
        <tr> 
          <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="260"><img src="images/banner_bg1.gif" width="260" height="17"></td>
                <td width="*" class="title_font">牌告利率每季申報資料 </td>
                <td width="260"><img src="images/banner_bg1.gif" width="260" height="17"></td>
              </tr>
            </table></td>
        </tr>
                    ...
                    <tr> 
                     <td class="body_bgcolor">
                      <table width="750" border="0" cellpadding="1" cellspacing="1">                       
                       <tr>                           
                        <td width="750" align=left><font color="red" size=2>註：「牌告利率每季明細資料」本排序欄位若未選取，則按「縣市別」、「金融機構代號名稱」及「年季」等欄位排序印出。</font></td>                              
                       </tr>                              
                      </table>
                     </td>
                    </tr>
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS015W_RptOrder.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
<%}%>
getbtnFieldList();
function getbtnFieldList(){
	...
	if(this.document.forms[0].BankList.value.indexOf("ALL") == -1){
	   ...
	   if(checkAdd == false){	  
	      this.document.forms[0].SortListSrc.options[addCount] = new Option("年季", "order_YYMM");
	      addCount++;
	   }	
    }else{//已選的機構代號=ALL全部
       //縣市別小計============================================================================================
