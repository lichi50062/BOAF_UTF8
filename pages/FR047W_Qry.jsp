...
<%
    ...
    System.out.println("FR047_Qry.muser_bank_type="+muser_bank_type);
      
    System.out.println("FR047_Qry.bank_type="+bank_type);
   	bank_type = ( request.getParameter("bank_type")==null ) ? "" : (String)request.getParameter("bank_type");			    	
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><center>信用部應予評估資產彙總表</center></font></td>
    <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
<%
...
$('#downloadLink').bind("mouseout",function(){
	$(this).children().attr("src","images/bt_exec.gif") ;
});
$('#downloadLink').bind("mouseover",function(){
	$(this).children().attr("src","images/bt_execb.gif") ;
});*/
//removeBankOption();
