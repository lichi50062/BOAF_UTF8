...
// 95.12.05 add 起始日期不可大於結束日期 by 2295
// 99.05.14 fix 欄位選取改共用./include/DS_RptColumn.include by 2808
...
<%
	...
	System.out.println("DS006W_RptColumn.szExcelAction="+szExcelAction);
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS006W_RptColumn.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	var bnlist;
