...
<%
	...
	System.out.println("DS019W_RptOrder.szExcelAction="+szExcelAction);
                    ...
                    <tr> 
                     <td class="body_bgcolor">
                      <table width="750" border="0" cellpadding="1" cellspacing="1">
                       ...
                       <tr>                           
                        <td width="750" align=left><font color="red" size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;「應予評估資產彙總資料」本排序欄位若未選取，則按「縣市別」、「金融機構代號名稱」及「年月」等欄位排序印出。</font></td>                              
                       </tr>                              
                      </table>
                     </td>
                    </tr>
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS019W_RptOrder.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
<%}%>
getbtnFieldList();
