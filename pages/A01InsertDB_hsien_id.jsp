<%
// 95.09.05 add 將農.漁會縣市別小計寫入a01_opeartion by 2295
...
// 99.05.04 fix (包含農漁會)套用DAO.preparestatment,並列印轉換後的SQL by 2295
...
<%
   ...
   out.print("產生("+("6".equals(bank_type)?"農":"漁")+"會-縣市別小計)A01_operation");
      
   String errMsg = Generate(report_no,s_year,s_month,bank_type,isDebug,lguser_id);
   System.out.println("errMsg ="+errMsg);
   System.out.println("=============產生A01_Operation結束===========");      
  
%>
<%!
public String Generate(String Report_no,String s_year,String s_month,String bank_type,String isDebug,String lguser_id) throws Exception{    	
		File logfile;
...
try{
	  ...
	  if(!logDir.exists()){
	   ...
	   logps.println(Utility.getDateFormat("yyyy/MM/dd  HH:mm:ss  ")+"產生"+s_year+"年"+s_month+"月 (農會-縣市別小計)A01_opeation 資料中");		    					    
	   logps.flush();
...
sqlCmd.append(" from (select a01.hsien_id ,  a01.hsien_name,  a01.FR001W_output_order,a01.bank_type,a01.bank_no , a01.bank_name, COUNT_SEQ, ");
sqlCmd.append("      		 field_SEQ, ");
...
paramList.add(s_month);
sqlCmd.append("			 where   a01.bank_no=a05.bank_code(+)  and a01.bank_no <> ' ' ");
sqlCmd.append("			GROUP  BY a01.hsien_id ,  a01.hsien_name,  a01.FR001W_output_order,a01.bank_type,a01.bank_no , a01.BANK_NAME ");
sqlCmd.append("		) a01 ");
sqlCmd.append("	  UNION ALL ");
sqlCmd.append("      select a01.hsien_id ,  a01.hsien_name,  a01.FR001W_output_order,a01.bank_type, ");
sqlCmd.append("             a01.bank_no ,a01.bank_name, ");
...
sqlCmd.append("	)  a01  ORDER by    FR001W_output_order, field_SEQ,  hsien_id ,  bank_no ");                                                                                                                                                                                                                                                                                                                                                                                                                  
	...
	dataList.add("hsien_id_"+bank_type); 
