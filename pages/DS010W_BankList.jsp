...
//95.10.30 無金額單位.無年月.各別機構有各受託債權催收機構.所以無縣市別統計 by 2295
...
<%
	...
	System.out.println("DS010W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("DS010W_BankList.hsien_id="+hsien_id);
                ...
                <td bordercolor="#E9F4E3" bgcolor="#E9F4E3"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E9F4E3">
                    ...
                    <tr> 
                 	  <td class="body_bgcolor">
                        ...
                        <tr>                           
                          <td width="750" align=left><font color="red" size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;選取[各信用部]：按「委外催收委外之對象明細資料」的報表內容列印</font></td>                              
                        </tr>                                                  
                        </table>
                      </td>
                    </tr>                  
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("DS010W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
