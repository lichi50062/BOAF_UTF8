...
// 99.05.17 fix 套用Header.include by2808 
...
<%
    ...
    if(!Utility.CheckPermission(request,report_no)){//無權限時,導向到LoginError.jsp//95.11.03 fix 使用Utility.CheckPermission檢核權限 by 2295
        ...
        if(act.equals("RptColumn")){//報表欄位              
			//List FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"F01_"+bank_type+"_master_"+acc_div+".TXT");						
			//System.out.println(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"F01_"+bank_type+"_master_"+acc_div+".TXT");
			List FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"F01_6_master.TXT");						
			/*F01.農會.全部.漁會.全部.都讀取bank_type=6的設定檔
            ...
            if(!bank_type.equals("ALL") && session.getAttribute("BankList") != null && ((String)session.getAttribute("BankList")).indexOf("ALL") != -1){
              FieldList = Utility.getFileData(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"F01_ALL_master.TXT");						
            }
            */
			System.out.println(Utility.getProperties("schemaDir")+System.getProperty("file.separator")+"F01_"+bank_type+"_master.TXT");
...
<%!
    private final static String report_no = "DS007W";
