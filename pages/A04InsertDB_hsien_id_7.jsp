<%
// 95.10.17 add 將漁會縣市別小計寫入a04_opeartion by 2295
...
try{
	   ...
	   logps.println(logformat.format(nowlog)+" "+"產生"+s_year+"年"+s_month+"月 (漁會-縣市別小計)A04_opeation 資料中");
	   logps.flush();
...
paramList.add(wlx01_m_year);
    ...
    for(int i=0;i<dbData.size();i++){
	    ...
	    logps.flush();
	    if(((DataObject)dbData.get(i)).getValue("field_over_a01") == null) continue;
