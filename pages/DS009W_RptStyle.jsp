...
//99.05.24 fix 套用共用畫面DS_RptStyle.include by 2808
%>
...
<%
	...
	System.out.println("DS009W_RptStyle.szExcelAction="+szExcelAction);
        ...
        <tr> 
          <td width="824"><table width="797" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="280" class="title_font">ATM裝設紀錄資料 </td>
                <td width="240"><img src="images/banner_bg1.gif" width="240" height="17"></td>
              </tr>
            </table></td>
        </tr>
