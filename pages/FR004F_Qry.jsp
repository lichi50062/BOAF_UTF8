...
function doSubmit(cnd,hasMonth){   
   ...
   this.document.forms[0].action = "/pages/FR004F_Excel.jsp?act="+cnd+"&hasMonth="+hasMonth;	
   this.document.forms[0].target = '_self';
   this.document.forms[0].submit();   
}

//94.03.10 add by egg
//重導FR004F_Qry.jsp頁面以致輸出對應之金融機構資料
function getData(form,item){
	if(item == 'cancel_no'){
		//初始BANK_NO值
	   	form.BANK_NO.value="";
	}
	form.action="/pages/FR004F_Qry.jsp?act=getData&test=nothing";
	form.submit();
}
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><b><center>漁會信用部<%if(hasMonth.equals("true")) out.print("單月");%>損益表</center></b></font></td>
    <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
