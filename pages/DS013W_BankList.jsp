...
//         add 有農/漁會的menu時,才可顯示農/漁會;登入者為地方主管機關時,只能看到自己的主管機關 by 2295
...
<%
	...
	System.out.println("DS013W_BankList.szExcelAction="+szExcelAction);
	String hsien_id = ( session.getAttribute("HSIEN_ID")==null ) ? "ALL" : (String)session.getAttribute("HSIEN_ID");				
	System.out.println("DS013W_BankList.hsien_id="+hsien_id);
...
function hideOption(){//機構類別為地方主管機關時.不可選縣市別
    if(this.document.forms[0].bank_type.value == 'B'){       
       this.document.forms[0].HSIEN_ID.disabled = true;        
    }else{
       this.document.forms[0].HSIEN_ID.disabled = false;        
    }
}
                    ...
                    <tr> 
                     ...
                     <tr> 
                 	  <td class="body_bgcolor">
                        ...
                        <tr>                           
                          <td width="750" align=left><font color="red" size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;選取[各信用部/地方主管機關]：按「承受擔保品延長處分申報情形明細資料」的報表內容列印</font></td>                              
                        </tr>                                                  
                        </table>
                      </td>
                    </tr>
...
if(session.getAttribute("BankList") != null && !((String)session.getAttribute("BankList")).equals("")){ 
   System.out.println("DS013W_BankList.BankList="+(String)session.getAttribute("BankList"));
%>
var bnlist;
