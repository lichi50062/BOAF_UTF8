...
<%@ page import="com.tradevan.util.report.RptFR034WA_BOAF" %>
...
<%
   ...
   if(session.getAttribute("muser_id") == null){//session timeout
      System.out.println("FR034WA login timeout");
    		...
    		*/
	    	...
	    	if(act.equals("Qry")){
   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
	    			actMsg = RptFR034WA_BOAF.createRpt(S_YEAR,S_MONTH,unit,bank_type);
...
<%!
    ...
    private final static String QryPgName = "/pages/FR034WA_Qry.jsp";
    private final static String RptCreatePgName = "/pages/FR034WA_Excel.jsp";
    private final static String LoginErrorPgName = "/pages/LoginError.jsp";
    private boolean CheckPermission(HttpServletRequest request){//檢核權限
    	    boolean CheckOK=false;
    	    HttpSession session = request.getSession();
            Properties permission = ( session.getAttribute("FR034WA")==null ) ? new Properties() : (Properties)session.getAttribute("FR034WA");
            if(permission == null){
              System.out.println("FR034WA.permission == null");
            }else{
               System.out.println("FR034WA.permission.size ="+permission.size());
