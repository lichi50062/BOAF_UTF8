<%
// 95.10.17 add 將全体農漁會縣市別小計寫入a04_opeartion by 2295
...
public String Generate(String Report_no,String s_year,String s_month,String isDebug,String lguser_id) throws Exception{
 ...
 try{
	   ...
	   logps.println(logformat.format(nowlog)+" "+"產生"+s_year+"年"+s_month+"月 (全体農漁會-縣市別小計)A04_opeation 資料中");
	   logps.flush();
...
paramList.add(wlx01_m_year);
    ...
    for(int i=0;i<dbData.size();i++){
    	...
    	logcalendar = Calendar.getInstance();
	    nowlog = logcalendar.getTime();
	    logps.println(logformat.format(nowlog)+" "+"縣市別:"+(String)((DataObject)dbData.get(i)).getValue("hsien_id"));
	    logps.flush();
