...
<%
	...
	System.out.println("Egg test WMFileEdit_M01.jsp");	
	//String Report = ( request.getParameter("Report")==null ) ? "" : (String)request.getParameter("Report");	
	String Report = ( request.getParameter("Report")==null ) ? "M01" : (String)request.getParameter("Report");		
	...
	System.out.println("S_YEAR="+S_YEAR);	System.out.println("S_MONTH="+S_MONTH);
	...
	if(act.equals("new")){
        ...
        sqlCmd.append(" select a.guarantee_item_no as \"guarantee_item_no\" ,a.guarantee_item_name ,b.data_range ,b.data_range_name ");
        sqlCmd.append(" from   m00_guarantee_item a,m00_data_range_item b ");
        sqlCmd.append(" where  ((a.guarantee_item_no<>'0' and b.data_range_type<>'T') ");
        sqlCmd.append(" or	 ( a.guarantee_item_no='0' and b.data_range_type='T')) ");
	...
	System.out.println("data_div01=" + data_div01);
%>
<html>
<head>
<style>
                    ...
                    <tr> 
                      ...
                      <td width="*"><font color='#000000' size=4><b> 
                        <center>
                          ...
                          <%}else{%>
                            <font color='#000000' size=4>線上編輯</font><font color="#CC0000">【<font size=4><%=ListArray.getDLIdName("4", "M01")%>】</font></font><font color='#000000' size=4></font> 
                          <%}%>  
                    ...
                    <tr> 
                      <td><Table width=1050 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">
                          <%if(act.equals("Query")){%>
                            ...
                            <td colspan=2 bgcolor='e7e7e7'>M01&nbsp;&nbsp;&nbsp;<%=ListArray.getDLIdName("4", "M01")%></td>
                          </tr>  
                          <%}%>
                          <tr class="sbody"> 
        			...
        			<option></option>
                        ...
                        <table width=1050 border='1' align='center' cellpadding="1" cellspacing="1" bordercolor="#3A9D99" class="sbody">
						  <tr bgcolor='e7e7e7' class="sbody"> 
                            <td bgcolor="#B1DEDC" rowspan=3> <div align=center>區分<BR>保證項目</div></td>
						  ...
						  <tr bgcolor='e7e7e7' class="sbody"> 
 			              ...
 			              <tr bgcolor='e7e7e7' class="sbody"><td bgcolor="#D8EFEE" colspan=14><div align=left>保證項目</div></td></tr>
 <% 		int i = 0 ;
		...
		while( i < data_div01.size()){
		    ...
		    System.out.print("tmpData_Range=["+"]");
		    System.out.println("tmpData_Range=["+tmpData_Range+"]");
		    if(tmpData_Range.equals("MM") ||tmpData_Range.equals("MT") ){%>
 			              <tr bgcolor='e7e7e7' class="sbody">
 			              <td bgcolor="#D8EFEE" colspan=14><div align=left><b><%=(String)((DataObject)data_div01.get(i)).getValue("guarantee_item_name")%></b></div>
 			              </td></tr>
			<%}%>
 			              <tr bgcolor='e7e7e7' class="sbody">
			                <td bgcolor="#D8EFEE"><div align=left><%= ((String)((DataObject)data_div01.get(i)).getValue("data_range_name")).trim()%></div>
			                 <input type=hidden value="<%=(String)((DataObject)data_div01.get(i)).getValue("guarantee_item_no")%>" name='guarantee_item_no_c'>
			                ...
			                <%if(((DataObject)data_div01.get(i)).getValue("repay_tot_amt") == null ||  (((DataObject)data_div01.get(i)).getValue("repay_tot_amt") != null && ((((DataObject)data_div01.get(i)).getValue("repay_tot_amt")).toString()).equals("0"))){%>
			                	<td><div align=left><input type='text' name='repay_tot_amt' class="small" value="" size=13 maxlength=14 onFocus='this.value=changeVal(this)' onBlur='checkPoint_focus(this);this.value=changeStr(this)' style='text-align: right;'></div></td>
			                <%}else{%>
		...
		<%	i=i+1;
              ...
              <tr> 
				...
				<%if(act.equals("new")){%>       
                        <td width="74"> <div align="center"><a href="javascript:doSubmit(this.document.forms[0],'Insert','M01','','','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image91','','images/bt_confirmb.gif',1)"><img src="images/bt_confirm.gif" name="Image91" width="66" height="25" border="0" id="Image91"></a></div></td>
         		<%}%>
         		<%if(act.equals("Edit")){%>
				        <td width="74"> <div align="center"><a href="javascript:doSubmit(this.document.forms[0],'Update','M01','<%=S_YEAR%>','<%=S_MONTH%>','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image91','','images/bt_confirmb.gif',1)"><img src="images/bt_confirm.gif" name="Image91" width="66" height="25" border="0" id="Image91"></a></div></td>
						<td width="66"> <div align="center"><a href="javascript:doSubmit(this.document.forms[0],'Delete','M01','<%=S_YEAR%>','<%=S_MONTH%>','');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image103','','images/bt_deleteb.gif',1)"><img src="images/bt_delete.gif" name="Image103" width="66" height="25" border="0" id="Image103"></a></div></td>
				<%}%>				
         		<%if(!act.equals("Query")){%>       
              ...
              <tr> 
                <td><table width="1050" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    ...
                    <tr> 
                      <td width="16">&nbsp;</td>
                      <td width="577"> <ul>
                          <li>本網頁提供新增<%=ListArray.getDLIdName("1", "M01")%>。</li>
