...
//105.11.18 add (TM006W)適用協助措施之經辦機構申報作業,提供A111111111或農金局,代銀行進行申報作業 by 2295
%>
...
<%
  ...
  //=====================================================================
   ...
   //login是A11111111的話 直接去抓在這分類(農會或漁會)所有的機構
   	    ...
   	    if(link_name.equals("TM006W")){
   	       sqlCmd_normal.append(" and bn01.bank_type in (?,?)");
   	       paramList_normal.add(bank_type);
   	       //sqlCmd_normal.append(" and bn01.bank_type=?");
   	    paramList_normal.add("A");//銀行
   		}else{
   		   sqlCmd_normal.append(" and bn01.bank_type = ?");
   	       paramList_normal.add(bank_type);   	   
   		}	
