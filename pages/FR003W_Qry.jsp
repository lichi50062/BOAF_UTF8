...
function doSubmit(cnd){   
   ...
   this.document.forms[0].action = "/pages/FR003W_Excel.jsp?act="+cnd;	
   this.document.forms[0].target = '_self';
   this.document.forms[0].submit();   
}
//94.03.10 add by egg
//重導FR003W_Qry.jsp頁面以致輸出對應之金融機構資料
function getData(form,item){
	if(item == 'cancel_no'){
		//初始BANK_NO值
	   	form.BANK_NO.value="";
	}
	form.action="/pages/FR003W_Qry.jsp?act=getData&test=nothing";
	form.submit();
}
...
<table width='600' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="50%"><font color='#000000' size=4><center>農會信用部資產負債表</center></font></td>
    <td width="25%"><img src="images/banner_bg1.gif" width="100%" height="17"></td>
  </tr>
</table>
