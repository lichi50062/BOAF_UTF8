...
<%
	...
	System.out.println("DS017W_RptColumn.szExcelAction="+szExcelAction);
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
	...
	<table width="830" border="0" align="center" cellpadding="1" cellspacing="1">        
        ...
        <tr> 
          <td><table width="830" border="1" align="center" cellpadding="0" cellspacing="0" class="bordercolor">
              <tr> 
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS017W_RptColumn.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	var bnlist;
