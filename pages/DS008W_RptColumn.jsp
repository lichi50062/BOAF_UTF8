...
//99.05.24 fix 欄位選取改共用./include/DS_RptColumn.include by 2808
%>
...
<%
	...
	System.out.println("DS008W_RptColumn.szExcelAction="+szExcelAction);
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS008W_RptColumn.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	var bnlist;
