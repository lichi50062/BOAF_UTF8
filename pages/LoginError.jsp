...
// 94.12.28 fix 顯示actMsg顯息在狀態列 by 2295
// 96.08.15 add 密碼必須為8碼的文數字組合 by 2295
// 98.09.21 fix 公告維護區 by 2295
//104.10.08 fix muser_id='null' by 2295
//105.01.08 fix 調整公告區,使用讀取Notify.jsp不直接查詢DB by 2295
%>
            ...
            <table width="330" border="0" align="center" cellpadding="0" cellspacing="0">													              
              <tr>
                <td><table width="330" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#006666">
                     <tr>                    	
        			 <td bordercolor="#63B1AE">
        			  <table width="330" border="0" align="center" cellpadding="1" cellspacing="0" bordercolor="#FFFFFF">    
        ...
        <tr> 
          ...
          <td rowspan="2" valign="top" bgcolor="#78B5B3">
			<table width="250" border="0" align="center" cellpadding="0" cellspacing="1" class="sbody">
              ...
              <tr> 
                <td colspan="2"><img src="images/icon_1.gif" width="12" height="12" align="absmiddle"> 
                  <font color="#FFFFFF">登入時間已超過,請重新登入
                  </font></td>
              </tr>
              <%}%>
