...
<%
	...
	if(permission == null){
       System.out.println("FX001W_EditM.permission == null");
    }else{
       System.out.println("FX001W_EditM.permission.size ="+permission.size());               
    }   	
   	//=======================================================================================================================	
	String BIRTH_DATE_Y="";
	String BIRTH_DATE_M="";
	...
	List tmpDate=null;
	if(WLX01_M != null && WLX01_M.size() != 0){
	    int i = 0;
		if(((DataObject)WLX01_M.get(0)).getValue("birth_date") != null){
		   BIRTH_DATE = Utility.getCHTdate((((DataObject)WLX01_M.get(0)).getValue("birth_date")).toString().substring(0, 10), 0);		 
		...
		if(((DataObject)WLX01_M.get(0)).getValue("induct_date") != null){
		   INDUCT_DATE = Utility.getCHTdate((((DataObject)WLX01_M.get(0)).getValue("induct_date")).toString().substring(0, 10), 0);
		...
		if(((DataObject)WLX01_M.get(0)).getValue("abdicate_date") != null){
		   ABDICATE_DATE = Utility.getCHTdate((((DataObject)WLX01_M.get(0)).getValue("abdicate_date")).toString().substring(0, 10), 0);
...
<input type="hidden" name="seq_no" value="<%if(WLX01_M != null && WLX01_M.size() != 0){out.print((((DataObject)WLX01_M.get(0)).getValue("seq_no")).toString());}%>">
                    ...
                    <tr> 
                      <td><table width=600 border=1 align=center cellpadding="1" cellspacing="1" bordercolor="#3A9D99">                          						
						...
						<td width='70%' colspan=3 bgcolor='e7e7e7'>
						    <input type='text' name='NAME' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print( (((DataObject)WLX01_M.get(0)).getValue("name") == null )?"":  (String)((DataObject)WLX01_M.get(0)).getValue("name"));%>" size='20' maxlength='20' >
						...
						<td width='70%' colspan=3 bgcolor='e7e7e7'>
						 <select name='SEX'>
						   <option value='M' <%if((WLX01_M == null) || ((WLX01_M != null && WLX01_M.size() != 0) && ( (((DataObject)WLX01_M.get(0)).getValue("sex") != null ) && ((String)((DataObject)WLX01_M.get(0)).getValue("sex")).equals("M") ) ) ) out.print("selected");%>>男</option>
        				   <option value='F' <%if((WLX01_M != null && WLX01_M.size() != 0) && (  (((DataObject)WLX01_M.get(0)).getValue("sex") != null ) && ((String)((DataObject)WLX01_M.get(0)).getValue("sex")).equals("F") ) ) out.print("selected");%>>女</option>						   
        				 </select>
        				</td>
        				</tr>						
						...
						<% List position_code = DBManager.QueryDB_SQLParam("select cmuse_id,cmuse_name from cdshareno where cmuse_div='005' order by input_order",null,"");%>
						<td width='70%' colspan=3 bgcolor='e7e7e7'>
                            ...
                            <%if((WLX01_M != null && WLX01_M.size() != 0) && (((String)((DataObject)position_code.get(i)).getValue("cmuse_id")).equals((String)((DataObject)WLX01_M.get(0)).getValue("position_code")))) out.print("selected");%>
                            >
                        ...
                        <tr class="sbody">
						  ...
						  <td width='70%' colspan=3 bgcolor='e7e7e7'>
                            <input type='text' name='RANK' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print( ((DataObject)WLX01_M.get(0)).getValue("rank") == null ?"":(((DataObject)WLX01_M.get(0)).getValue("rank")).toString());%>" size=5 maxlength=5>
        					(請輸入阿拉伯數字 或 不輸入)
                          </td>
	  					</tr>
						...
						<td width='35%' bgcolor='e7e7e7'>
						    <input type='text' name='ID' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print(Utility.maskChar(Utility.decode((String)((DataObject)WLX01_M.get(0)).getValue("id")),4,4,"*"));%>" size='10' maxlength='10' size='10' maxlength='10' >    
						    <input type='hidden' name='encode_ID' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print((String)((DataObject)WLX01_M.get(0)).getValue("id"));%>" >                     						  
						    <font color='red' size=4>*</font>    
                        </td>
                        <td width='35%' bgcolor='e7e7e7'>
                            是否確定
                            <select name=ID_CODE >
                            <option value="Y" <%if((WLX01_M != null && WLX01_M.size() != 0) &&  (((DataObject)WLX01_M.get(0)).getValue("id_code") != null && ((String)((DataObject)WLX01_M.get(0)).getValue("id_code")).equals("Y"))  ) out.print("selected");%>>Y</option>
                            <option value="N" <%if((WLX01_M == null) || (WLX01_M.size() == 0) || ((WLX01_M != null && WLX01_M.size() != 0) &&  ((((DataObject)WLX01_M.get(0)).getValue("id_code") == null) || ((String)((DataObject)WLX01_M.get(0)).getValue("id_code")).equals("N")))   ) out.print("selected");%>>N</option>   
                            </select>   
                            <input type="button" name="load" value="載入" onClick="javascript:loadData(form,'loadM','<%=act%>');">                      
                        </td>
                        </tr>	
                        ...
                        <tr class="sbody">
						  ...
						  <td width='70%' colspan=3 bgcolor='e7e7e7'>
                            <input type='text' name='DEGREE' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print( ( ((DataObject)WLX01_M.get(0)).getValue("degree") == null)?"":(String)((DataObject)WLX01_M.get(0)).getValue("degree"));%>" size='50' maxlength='100'>
        					</td>
	  					</tr>	  					
						...
						<td width='70%' colspan=3 bgcolor='e7e7e7'>						
        				 <input type='text' name='TELNO' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print(((String)((DataObject)WLX01_M.get(0)).getValue("telno") == null)?"":(String)((DataObject)WLX01_M.get(0)).getValue("telno"));%>" size='20' maxlength='20' >(含區域號碼，並以"-"區隔)                            
        			    </td>
        			    </tr>		
						...
						<td width='70%' colspan=3 bgcolor='e7e7e7'>						
        				 <input type='text' name='FAX' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print(((String)((DataObject)WLX01_M.get(0)).getValue("fax") == null)?"":(String)((DataObject)WLX01_M.get(0)).getValue("fax"));%>" size='20' maxlength='20' >(含區域號碼，並以"-"區隔)                            
        			    </td>
        			    </tr>	
        			    ...
        			    <tr class="sbody">
						  ...
						  <td width='35%' bgcolor='e7e7e7'>
                            ...
                            <input type='text' name='ABDICATE_DATE_Y' value="<%=ABDICATE_DATE_Y%>" size='3' maxlength='3' onblur='CheckYear(this)' <%if((WLX01_M == null) || ((WLX01_M != null && WLX01_M.size() != 0) &&  ((((DataObject)WLX01_M.get(0)).getValue("abdicate_code") != null) && ((String)((DataObject)WLX01_M.get(0)).getValue("abdicate_code")).equals("N")))) out.print("disabled");%>>
        						<font color='#000000'>年
        						<select id="hide1" name=ABDICATE_DATE_M <%if((WLX01_M == null) || ((WLX01_M != null && WLX01_M.size() != 0) &&  ((((DataObject)WLX01_M.get(0)).getValue("abdicate_code") != null) && ((String)((DataObject)WLX01_M.get(0)).getValue("abdicate_code")).equals("N")))) out.print("disabled");%>>
        						<option></option>
        						<%
        							for (int j = 1; j <= 12; j++) {
        							if (j < 10){%>        	
        						...
        						<select id="hide1" name=ABDICATE_DATE_D <%if((WLX01_M == null) || ((WLX01_M != null && WLX01_M.size() != 0) &&  ((((DataObject)WLX01_M.get(0)).getValue("abdicate_code") != null) && ((String)((DataObject)WLX01_M.get(0)).getValue("abdicate_code")).equals("N")))) out.print("disabled");%>>
        						<option></option>
        						<%
        							for (int j = 1; j < 32; j++) {
        							if (j < 10){%>        	
                            ...
                            <option value="Y" <%if((WLX01_M != null && WLX01_M.size() != 0) &&  (((DataObject)WLX01_M.get(0)).getValue("abdicate_code") != null && ((String)((DataObject)WLX01_M.get(0)).getValue("abdicate_code")).equals("Y"))  ) out.print("selected");%>>Y</option>
                            <option value="N" <%if((WLX01_M == null) || (WLX01_M.size() == 0) || ((WLX01_M != null && WLX01_M.size() != 0) &&  ((((DataObject)WLX01_M.get(0)).getValue("abdicate_code") == null) || ((String)((DataObject)WLX01_M.get(0)).getValue("abdicate_code")).equals("N")))   ) out.print("selected");%>>N</option>   
                            </select>                         
						...
						<td width='70%' colspan=3 bgcolor='e7e7e7'>
						    <input type='text' name='BACKGROUND' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print(((String)((DataObject)WLX01_M.get(0)).getValue("background") == null)?"":(String)((DataObject)WLX01_M.get(0)).getValue("background"));%>" size='50' maxlength='100'>                          
                        </td>
                        </tr>
        			    ...
        			    <tr class="sbody">
						  ...
						  <td width='70%' colspan=3 bgcolor='e7e7e7'>
                            <input type='text' name='EMAIL' value="<%if(WLX01_M != null && WLX01_M.size() != 0) out.print(((String)((DataObject)WLX01_M.get(0)).getValue("email") == null)?"":(String)((DataObject)WLX01_M.get(0)).getValue("email"));%>" size='30' maxlength='60'>
        				  </td>
	  					</tr>	 
                        </Table></td>
                    </tr>                 
              ...
              <tr> 
                <td><div align="center"> 
                    <table width="243" border="0" cellpadding="1" cellspacing="1">
                      <tr>   
                        <%if(haveCancel.equals("N")){//94.04.06總機構未裁撤時才能執行修改.卸任.刪除%>
                ...
                <td><table width="600" border="0" cellpadding="1" cellspacing="1" class="sbody">
                    ...
                    <tr> 
                      ...
                      <td width="577"> <ul>
        				  ...
        				  <li><font color="red">總機構已裁撤時,僅可查詢不可再辦理異動事宜。</font></li>
                        </ul></td>
                    </tr>
                  </table></td>
              </tr>
