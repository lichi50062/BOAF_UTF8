...
// 95.10.25 add order by 本月餘額a_1_bal_tm by 2295 	  
...
<%
	...
	System.out.println("DS007W_RptOrder.szExcelAction="+szExcelAction);
                    ...
                    <%@include file="./include/DS_RptOrder.include" %><!-- 排序欄位.可挑選項目-->
                     ...
                     <td class="body_bgcolor">
                      <table width="750" border="0" cellpadding="1" cellspacing="1">
                       ...
                       <tr>                           
                        <td width="750" align=left><font color="red" size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;「在台無住所之外國人新台幣存款表明細資料」本排序欄位若未選取，則按「縣市別」、「金融機構代號名稱」及「年月」</font></td>                              
                       </tr>                              
                       <tr>                           
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS007W_RptOrder.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
<%}%>
getbtnFieldList();
function getbtnFieldList(){
	...
	if(this.document.forms[0].BankList.value.indexOf("ALL") == -1){
       ...
       if(checkAdd == false){	  
          this.document.forms[0].SortListSrc.options[addCount] = new Option("金融機構代號名稱", "f01.bank_code");
          addCount++;
       }
       //年.月===================================================================================================
       checkAdd = false;
	...
	for (var i =0; i < a.length; i ++){
    	...
    	if(checkAdd == false){	       	       
    	    ...
    	    //   continue;
    	    //}
    	    //95.10.25 add order by 本月餘額a_1_bal_tm  	    
       		this.document.forms[0].SortListSrc.options[addCount] = new Option(j[1], j[0].substring(4,7)+"_bal_tm");
       		addCount++;
    	}	
	}*/	
}
