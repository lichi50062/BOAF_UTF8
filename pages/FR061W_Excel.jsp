...
<%
   ...
   System.out.println("FR061W_Excel.act="+act);
   ...
   if(doProcess){//若muser_id資料時,表示登入成功====================================================================
   		if(!Utility.CheckPermission(request,"FR061W")){//無權限時,導向到LoginError.jsp
	    	...
	    	if(act.equals("Qry")){
   			...
   			*/
   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
	    			actMsg =RptFR061W.createRpt(S_YEAR,S_MONTH,"1000",bank_code);
...
<%!
    ...
    private final static String QryPgName = "/pages/FR061W_Qry.jsp";
    private final static String RptCreatePgName = "/pages/FR061W_Excel.jsp";
