...
//99.05.14 fix 套用共用畫面DS_RptColumn.include by 2808
%>
...
String act = Utility.getTrimString(dataMap.get("act"));					
	...
	System.out.println("DS004W_RptColumn.szExcelAction="+szExcelAction);
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS004W_RptColumn.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
	var bnlist;
