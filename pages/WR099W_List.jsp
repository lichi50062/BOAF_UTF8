                    ...
                    <tr> 
                      ...
                      if(reportList != null){ %>
                    		...
                    		<tr class="<%=listColor%>">                       	  
                               ...
                               <td width="220">
                               <%if( ((DataObject)reportList.get(i)).getValue("s_report_name") != null ) out.print("<a href='WR099W.jsp?act=Download&filename="+(String)((DataObject)reportList.get(i)).getValue("rpt_fname")+"&yyymm="+yyymm+"&RPT_CODE="+szrpt_code+"'>"+(String)((DataObject)reportList.get(i)).getValue("s_report_name")+"</a>"); else out.print("&nbsp;");%>
                               </td>
            				   <td width="60">
