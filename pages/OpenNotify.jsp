...
<%  
       ...
       {    
       		...
       		mySmartUpload.downloadFile(downloadlink,"application/msword",file_name); 
       } 
       if(file_type.equals("xls"))
       {
     		  System.out.println("file_name:"+file_name);
     		  mySmartUpload.setContentDisposition(null);       
     		  mySmartUpload.downloadFile(downloadlink,"application/vnd.ms-excel",file_name);       
       }
       if(file_type.equals("pps"))
       {
     		  System.out.println("file_name:"+file_name);
     		  mySmartUpload.setContentDisposition(null);       
     		  mySmartUpload.downloadFile(downloadlink,"application/vnd.ms-powerpoint",file_name);
       }
       if(file_type.equals("zip"))
       {
     		  System.out.println("file_name:"+file_name);
     		  mySmartUpload.setContentDisposition("inline;");       
     		  mySmartUpload.downloadFile(downloadlink,"application/x-zip-compressed",file_name);      
       }
       ...
       //102.12.03 add pdf 下載
       if(file_type.equals("pdf"))
       {
     		  System.out.println("file_name:"+file_name);
     		  mySmartUpload.setContentDisposition("inline;");       
     		  mySmartUpload.downloadFile(downloadlink,"application/pdf",file_name);           		  
       }
%>
