<%
//101.07.30 created M_106貸款用途分析表 by 2968
%>
...
<%
   ...
   System.out.println("FR059W_Excel.act="+act);
   ...
   if(doProcess){//若muser_id資料時,表示登入成功====================================================================
   		if(!Utility.CheckPermission(request,"FR059W")){//無權限時,導向到LoginError.jsp
	    	...
	    	if(act.equals("Qry")){
   			...
   			*/
   			...
   			if(act.equals("view") || act.equals("download")){
   				try{
	    			actMsg =RptFR059W.createRpt(S_YEAR,S_MONTH,Unit,bank_code);
...
<%!
    ...
    private final static String QryPgName = "/pages/FR059W_Qry.jsp";
    private final static String RptCreatePgName = "/pages/FR059W_Excel.jsp";
