...
//95.11.20 add 因有明細.跟各個機構小計.所以無其他可選欄位的sort by 2295
...
<%
	...
	System.out.println("DS009W_RptOrder.szExcelAction="+szExcelAction);
%>
        ...
        <tr> 
          <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="*" class="title_font">ATM裝設紀錄資料 </td>
                <td width="240"><img src="images/banner_bg1.gif" width="240" height="17"></td>
              </tr>
            </table></td>
        </tr>
                    ...
                    <%@include file="./include/DS_RptOrder.include" %><!-- 排序欄位.可挑選項目-->
                     ...
                     <td class="body_bgcolor">
                      <table width="750" border="0" cellpadding="1" cellspacing="1">                       
                       <tr>                           
                        <td width="750" align=left><font color="red" size=2>註：「ATM裝設紀錄明細資料」本排序欄位若未選取，則按「縣市別」、「金融機構代號名稱」等欄位排序印出。</font></td>                              
                       </tr>                              
                      </table>
                     </td>
                    </tr>
...
if(session.getAttribute("btnFieldList") != null && !((String)session.getAttribute("btnFieldList")).equals("")){ 
   System.out.println("DS009W_RptOrder.btnFieldList="+(String)session.getAttribute("btnFieldList"));
%>
<%}%>
getbtnFieldList();
function getbtnFieldList(){
    ...
    //======================================================================================================
    //已選的報表欄位
    /*95.11.20因有明細.跟各個機構小計.所以無其他可選欄位的sort
	for (var i =0; i < a.length; i ++){
		var j = a[i].split('+');
		checkAdd=false;		
		for(var k =0;k<this.document.forms[0].SortListDst.length;k++){			
